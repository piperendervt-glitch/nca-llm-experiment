...
NCA v4: Devil's Advocate + Confidence-Weighted Neighbor Influence
  - Builds on v3's devil's advocate and neutral language
  - Explicitly shows neighbor confidence and instructs weighting by confidence
...
def format_neighbor(label: str, output: dict) -> str:
    """Format a neighbor's output emphasizing confidence for the prompt."""
...
def nca_update(node_id: int, task_input: str, neighbor_outputs: list[dict]) -> dict:
    """NCA更新ステップ。信頼度加重 + Devil's Advocate。"""
